  ...
  return (
    ...
    <form className="addProductForm">
      ...
      <div className="addProductItem">
        ...
        <div className="addProductItem">
        <label>Size</label>
        <input name="size" type="text" placeholder="XS,S,M,L,XL" onChange={handleSize}/>
        </div>
        <div className="addProductItem">
        <label>Color</label>
        <input name="color" type="text" placeholder="White,Black,Blue.." onChange={handleColor}/>
        </div>
      <div className="addProductItem">
        <label>Price</label>
      ...
      <div className="addProductItem">
        ...
        <input type="text" placeholder="shirt,jacket,loungewear" onChange={handleCat}/>
      </div>
      <div className="addProductItem">
        <label>Stock</label>
